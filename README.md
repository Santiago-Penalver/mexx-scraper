# Hardware Tracker - Scraper Multi-Tienda
...
* **Web Scraping:** BeautifulSoup4, Requests y Fake_UserAgent.
* **Base de Datos:** SQLite3 (Persistencia de datos en `hardware_tracker.db`)
...
* Dashboard principal con contadores dinámicos que calculan la cantidad de productos listados en total, Y cuántos pertenecen a cada una de las marcas reyes de la industria del Hardware.
